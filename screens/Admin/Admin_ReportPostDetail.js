...
export default function Admin_ReportPostDetail({ route }) {
        ...
        },
        {
          ...
          onPress: async () => {
            ...
            try {
              ...
              Alert.alert(
                "Success",
                "Post and associated reports have been deleted."
              );
              navigation.goBack();
            } catch (error) {
              ...
              Alert.alert(
                "Error",
                "Failed to delete post and reports. Please try again."
              );
            }
          },
        },
